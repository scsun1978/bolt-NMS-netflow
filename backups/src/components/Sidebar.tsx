...
import { ChevronLeft, ChevronRight, Grid, List, ExclamationTriangle, Eye, Bell, BarChart } from 'react-bootstrap-icons';
...
const Sidebar = ({ isCollapsed, toggleSidebar }) => {
  ...
  return (
    <Nav className={`flex-column h-100 py-3 ${isCollapsed ? 'collapsed' : ''}`} style={{ backgroundColor: '#0052CC', color: 'white' }}>
      ...
      <Nav.Item>
        <Nav.Link as={Link} to="/traffic-analysis" className="d-flex align-items-center text-white">
